...
#include <vector>
#include <memory>
#include "GLViewExampleComputeShader.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewExampleComputeShader > glView( Aftr::GLViewExampleComputeShader::New( args ) );
